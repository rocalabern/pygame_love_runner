...
def show_image(screen, width, height):
    image_file = "images/wedding/rewards/end_level_animation_tutorial_05.png"
    ...
    pg_print_message(screen, "Más vale pan duro que ...", int(round(width / 5)), int(round(height / 6)), size=64)
